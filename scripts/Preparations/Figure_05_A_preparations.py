#----Figure_05_A_preparation----------------------------------------------------
#-------------------------------------------------------------------------------
# This is the code which has to be run in preparation for Figure 05 Panel A
...
result.to_csv("./input/tmp/Figure_05_A_DN_input_from_clk_bridge_filtered_v"+v+".csv")
